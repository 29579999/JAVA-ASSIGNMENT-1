...
public class Q1_3_PalindromeAnagram {
    ...
    public static void main(String[] args) {
        ...
        boolean valid = str1.matches("[a-zA-Z0-9]+");
        ...
        String palindromeResult =
                String.format("Palindrome : %s", palindrome);

        String anagramResult =
                String.format("Anagram : %s", anagram);

        String formattedReport =
                String.join(" | ", palindromeResult, anagramResult);
